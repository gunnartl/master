...
plt.plot(3600*24*np.cumsum(np.nanmean(yearlyMean1920[:,changeMask],axis=1)),label="1920")
...
plt.title("Runoff change in gridcells with vegetation change")
...
plt.title("Change in transpiration in gridcells with vegetation change")
plt.savefig("../figurer/delta"+variable+"AverageLine.pdf",format="pdf",dpi=300)
plt.savefig("../figurer/delta"+variable+"AverageLine.png",format="png",dpi=300) 
...
plt.title("Cumulative change in evapotranspiration \n in gridcells with vegetation change")
...
a = np.nanmean(yearlyMean2020[:,changeMask] - yearlyMean1920[:,changeMask])
print( a )
print(a/np.mean(yearlyMean1920[:,changeMask]))

plt.plot(np.nanmean(yearlyMean2020[:,changeMask]-yearlyMean1920[:,changeMask],axis=1))
...
plt.plot(np.nanmean(yearlyMean1920[:,changeMask],axis=1),label="1920")
plt.plot(np.nanmean(yearlyMean2020[:,changeMask],axis=1),label="2020")
plt.legend()
plt.xlabel("Day of year")
plt.ylabel("Total water storage [$mm$]")
plt.title("Total water storage in gridcells with vegetation change")
plt.savefig("../figurer/"+variable+"AverageLine.pdf",format="pdf",dpi=300)
plt.savefig("../figurer/"+variable+"AverageLine.png",format="png",dpi=300) 
#plt.show()
plt.figure(figsize=(7,5))
plt.plot(np.nanmean(yearlyMean2020[:,changeMask],axis=1)-np.nanmean(yearlyMean1920[:,changeMask],axis=1),label="2020-1920")#,ciao come va? alloraaaa maddaiii se fai il bravo ti do un biscotto!
plt.legend()
plt.xlabel("Day of year")
plt.ylabel("$\Delta$ Total water storange [$mm$]")
plt.title("Total water storage in gridcells with vegetation change ")
plt.savefig("../figurer/delta"+variable+"AverageLine.pdf",format="pdf",dpi=300)
plt.savefig("../figurer/delta"+variable+"AverageLine.png",format="png",dpi=300) 
plt.show()
...
plt.plot(np.cumsum(24*3600*np.nanmean(yearlyMean1920[:,changeMask],axis=1)),label="1920")
plt.plot(np.cumsum(24*3600*np.nanmean(yearlyMean2020[:,changeMask],axis=1)),label="2020")
plt.legend()
plt.xlabel("Day of year")
plt.ylabel("Evaporation and  [$mm/h$]")
plt.title("Cumulative evaporation and sublimation from surface in gridcells with vegetation change")
plt.savefig("../figurer/cumulative"+variable+"AverageLine.pdf",format="pdf",dpi=300)
plt.savefig("../figurer/cumulative"+variable+"AverageLine.png",format="png",dpi=300) 
#plt.show()

plt.figure(figsize=(7,5))
plt.plot(3600*24*np.cumsum(np.nanmean(yearlyMean2020[:,changeMask],axis=1)-np.nanmean(yearlyMean1920[:,changeMask],axis=1)),label="2020-1920")#,ciao come va? alloraaaa maddaiii se fai il bravo ti do un biscotto!
plt.legend()
plt.xlabel("Day of year")
plt.ylabel("$\Delta$ evaporation and sublimation [$mm$]")
plt.title("Cumulative $\Delta$ evaporation and sublimation from surface \n in gricdells with vegetation change")
plt.savefig("../figurer/cumulative"+variable+"AverageLine.pdf",format="pdf",dpi=300)
plt.savefig("../figurer/cumulative"+variable+"AverageLine.png",format="png",dpi=300) 
#plt.show()"""